    ...
    <div className="flex flex-col gap-3">
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden p-4">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-[11px] font-bold text-slate-800 uppercase tracking-tight">Digital Archive</h2>
            ...
            items.slice(0, 5).map((book) => (
              <div key={book.id} className="flex gap-3 p-1.5 rounded-xl cursor-pointer group">
                ...
                <div className="flex flex-col justify-center min-w-0 flex-1">
                  <span className="text-[11px] font-bold truncate text-slate-900 mb-0.5">
        ...
        {items.length > 5 && (
          <button className="w-full mt-4 py-1.5 rounded-lg border border-slate-200 text-[10px] font-bold uppercase tracking-widest text-slate-400 hover:bg-slate-50 hover:text-slate-600 transition-all">
