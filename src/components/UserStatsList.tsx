          ...
          <table className="w-full text-left text-[11px]">
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
              {stats.length === 0 ? (
                ...
                stats.map((user) => (
                  <tr key={user.userId} className="group hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                    ...
                    <td className="px-4 py-2 font-bold text-slate-700 dark:text-slate-300">{formatDuration(user.totalTime)}</td>
                    ...
                    <td className="px-4 py-2 text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        <span className={cn(
                          ...
                          user.totalTime > 0 ? "bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400" : "bg-slate-100 dark:bg-slate-800 text-slate-400"
                        )}>
